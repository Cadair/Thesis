...
%TODO: Copy the data to make this work
%\begin{pycode}[chapter4]
%#This is a direct yank of an old script
%
%from flux_comparison import make_flux_bar_chart
%
%fig = make_flux_bar_chart((texfigure.figsize(pytex)[0], 4.5), "/archive/processed/data/driver_paper")
%driver_flux = ch4.save_figure('flux_bar_graph', fig, fext='.pgf')
