...
\chapter[]{MHD Waves excited by Different Photospheric Drivers\footnote{This chapter is based on \cite{mumford2015} with permission from the copyright holder.}}\label{ch:drivers}
