...
ch4 = Chapter(pytex, 4, './Chapter4/')
\end{pycode}

\graphicspath{\py|ch4.fig_path|}
...
for driver_func in drivers:
    ...
    plt.tight_layout()
    ch4.save_figure(driver_func.__name__, fig)

\end{pycode}

\begin{figure}[h]
	\py[chapter4]|ch4.build_subfigure('arch', width=r'0.49\columnwidth', caption="
	Archemdian spiral velocity field with expansion factor $B_A=0.005$")|
	\py[chapter4]|ch4.build_subfigure('log', width=r'0.49\columnwidth', caption="
	Logarithmic spiral velocity field with expansion factor $B_L=0.05$")|

	\centering
	\py[chapter4]|ch4.build_subfigure('uniform', width=r'0.49\columnwidth', caption="
...
\section{Comparing Wave Excitation}
