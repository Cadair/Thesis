...
\begin{figure*}
    ...
    \begin{subfigure}[b]{\columnwidth}
        ...
        \caption{1D slice through the centre of the domain. The green line shows a fitted gaussian to the numerical domain. The cyan lines show the FWHM and the magenta line shows the FWTM.~\citep{theastropycollaboration2013}}
