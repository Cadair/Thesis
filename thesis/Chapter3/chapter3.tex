...
To perform these experiments, it is needed that a background atmosphere be constructed.
...
\cite{feng2013} perform a study of Photospheric Bright Points(PBPs), which are assumed to be analogous to MBPs, using the Dutch Open Telescope, and find the peak of the lognormal distribution give a diameter of $232\pm40$ km for the quiet Sun.
...
\cite{utz2013} perform a similar study looking at the average magnetic field strength of MBPs
