...
print(gaussian._repr_latex_(), file=sys.stderr])
...
This section describes the numerical construction one of these flux surfaces, and the set of normal vectors defined upon it.
...
The first step, shown in \cref{fig:circ-seeds}, is the selection of the seed points for the field lines.
