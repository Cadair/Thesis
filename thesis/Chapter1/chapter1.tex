...
The solar corona (Figure~\ref{fig:aia171}) is very hot, with temperatures exceeding 10 Million degrees Kelvin, however, it is also very rarefied, with densities of the order of $1.6\times10^{-12}\ \text{kg}/\text{m}^3$. \py[chapter1]|mwdata['rho'][-1]._repr_latex_()|
...
ch1.save_figure('gband', fig)
\end{pycode}

\py[chapter1]|ch1.build_figure('gband', caption="A G-Band image of the solar photosphere.")|
