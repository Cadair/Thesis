...
The solar corona is very hot, with temperatures exceeding 10 Million degrees Kelvin,
...
caption="The solar corona at 17.1nm, showing plasma in the region of 1 million degrees Kelvin. Taken by the AIA instrument on the SDO spacecraft on {date:%d %b %Y at %H:%M}".format(date=parse_time(aia171.date)))|
