...
ds = pysac.yt.SACGDFDataset((ch2.data_file('Slog_p240-0_A10_B005_00001.gdf')))
tube_r = 60
...
ch2.save_mayavi_figure('zoomed_glyphs', scene, azimuth = 85, elevation = 80, distance=50, focalpoint=[63, 120, 110], aa=20)
\end{pycode}
